<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Demos.Samples.CSharp.GanttChartView.Baseline.Index" %>
...
<html>
<head runat="server">
    <title>GanttChartView Baseline Sample</title>
