<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Demos.Samples.CSharp.GanttChartView.ChangeNotifications.Index" %>
...
<html>
<head runat="server">
    <title>GanttChartView Change Notifications Sample</title>
