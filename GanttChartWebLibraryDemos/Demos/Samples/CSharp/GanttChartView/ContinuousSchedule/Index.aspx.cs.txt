...
namespace Demos.Samples.CSharp.GanttChartView.ContinuousSchedule
{ 
    public partial class Index : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                // Initialize continuous schedule as the default schedule for all items displayed by the component.
