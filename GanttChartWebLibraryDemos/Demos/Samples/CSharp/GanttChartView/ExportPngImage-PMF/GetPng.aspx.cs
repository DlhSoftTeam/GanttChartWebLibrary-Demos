...
using pdl::DlhSoft.Windows.Controls;
using pd::DlhSoft.Windows.Services;

namespace Demos.Samples.CSharp.GanttChartView.ExportPngImage_PMF
{
    public partial class GetPng : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            var taskManager = new pd::DlhSoft.Windows.Data.TaskManager();
