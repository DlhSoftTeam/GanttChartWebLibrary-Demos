<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Demos.Samples.CSharp.GanttChartView.MainFeatures_Item.Index" %>
...
<body>
    ...
    <ContentTemplate>
        ...
        <pdgcc:GanttChartView ID="GanttChartView" runat="server" Height="268px" Width="780px"/>
    </ContentTemplate>
    <Triggers>
