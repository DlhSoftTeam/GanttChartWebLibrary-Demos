<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Demos.Samples.CSharp.GanttChartView.MaterialResources.Index" %>
...
<html>
<head runat="server">
    <title>GanttChartView Material Resources Sample</title>
                ...
                <div class="ribbonPanel">
                    ...
                    <div class="ribbonCommandsArea">
                        <div class="ribbonCommand">
                            <asp:Button ID="LevelResourcesButton" runat="server" OnClick="LevelResourcesButton_Click" Text="Level resources" />
                        </div>
                    </div>
                </div>
                <div class="content">
                    Click the command button to level resources based on their required amounts of each of them on each task and their available quantities.
                </div>
            </div>
