<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Demos.Samples.CSharp.GanttChartView.MinuteScale.Index" %>
...
<html>
<head runat="server">
    <title>GanttChartView Minute Scale Sample</title>
