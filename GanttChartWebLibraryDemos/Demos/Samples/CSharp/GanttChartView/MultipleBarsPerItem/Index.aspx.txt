<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Demos.Samples.CSharp.GanttChartView.MultipleBarsPerItem.Index" %>
...
<html>
<head runat="server">
    <title>GanttChartView Multiple Bars Per Item Sample</title>
