<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Demos.Samples.CSharp.GanttChartView.Performance.Index" %>
...
<html>
<head runat="server">
    <title>GanttChartView Performance Sample</title>
