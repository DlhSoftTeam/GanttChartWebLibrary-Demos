...
<body>
    ...
    <asp:UpdatePanel ID="MainPanel" runat="server">
        ...
        <Triggers>
            ...
            <asp:PostBackTrigger ControlID="IsContentReadOnlyCheckBox" />
            <asp:PostBackTrigger ControlID="AreSchedulingColumnsReadOnlyCheckBox" />
            <asp:PostBackTrigger ControlID="AreAssignmentsReadOnlyCheckBox" />
            <asp:PostBackTrigger ControlID="IsEffortPreservedWhenStartChangesInGridCheckBox" />
            ...
            <asp:PostBackTrigger ControlID="HideDependenciesCheckBox" />
            <asp:PostBackTrigger ControlID="DisableCreatingStartDependenciesCheckBox" />
            <asp:PostBackTrigger ControlID="AreDependenciesReadOnlyCheckBox" />
            <asp:PostBackTrigger ControlID="DisableScrollingOnTaskClickCheckBox" />
            <asp:PostBackTrigger ControlID="SelectedItemAsReadOnlyButton" />
            <asp:PostBackTrigger ControlID="SelectedItemBarAsReadOnlyButton" />
        </Triggers>
    </asp:UpdatePanel>
    </form>
</body>
