<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Demos.Samples.CSharp.GanttChartView.SpecialDays.Index" %>
...
<html>
<head runat="server">
    <title>GanttChartView Special Days Sample</title>
