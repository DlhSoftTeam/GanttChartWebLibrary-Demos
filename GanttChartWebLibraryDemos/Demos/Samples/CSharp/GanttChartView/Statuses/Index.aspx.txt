<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Demos.Samples.CSharp.GanttChartView.Statuses.Index" %>
...
<html>
<head runat="server">
    <title>GanttChartView Statuses Sample</title>
