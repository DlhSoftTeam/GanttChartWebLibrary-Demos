...
namespace Demos.Samples.CSharp.GanttChartView.Styling
{ 
    public partial class Index : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                GanttChartView.CellCssClass = "cell";
                GanttChartView.ToggleButtonCssClass = "toggleButton";
                GanttChartView.ToggleButtonHoveringCssClass = "toggleButtonHovering";
                GanttChartView.StandardBarCssClass = "standardBar";
                GanttChartView.StandardCompletedBarCssClass = "darkBar";
                GanttChartView.SummaryBarCssClass = "darkBar";
                GanttChartView.MilestoneBarCssClass = "darkBar";
                GanttChartView.AssignmentsCssClass = "assignments";
                GanttChartView.DependencyLineCssClass = "dependencyLine";
                GanttChartView.BaselineBarCssClass = "baselineBar";
