<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Demos.Samples.CSharp.GanttChartView.TimeConstraints.Index" %>
...
<html>
<head runat="server">
    <title>GanttChartView Time Constraints Sample</title>
