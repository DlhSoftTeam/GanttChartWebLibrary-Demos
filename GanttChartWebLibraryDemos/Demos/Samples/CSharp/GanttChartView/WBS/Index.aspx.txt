<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Demos.Samples.CSharp.GanttChartView.WBS.Index" %>
...
<html>
<head runat="server">
    <title>GanttChartView WBS Sample</title>
