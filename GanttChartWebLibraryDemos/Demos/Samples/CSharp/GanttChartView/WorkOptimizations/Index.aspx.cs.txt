...
namespace Demos.Samples.CSharp.GanttChartView.WorkOptimizations
{ 
    public partial class Index : System.Web.UI.Page
    {
        ...
        public void OptimizeWorkButton_Click(object sender, EventArgs e)
        {
            string startTextBox = Request.Form["startTextBox"].ToString();
            GanttChartView.OptimizeWork(DependenciesOnlyCheckBox.Checked, IncludeStartedTasksCheckBox.Checked, startTextBox.Trim().Length > 0 ? DateTime.Parse(startTextBox) : GanttChartView.CurrentTime);
        }
        public void LevelResourcesButton_Click(object sender, EventArgs e)
        {
            string startTextBox = Request.Form["startTextBox"].ToString();
            GanttChartView.LevelResources(IncludeStartedTasksCheckBox.Checked, startTextBox.Trim().Length > 0 ? DateTime.Parse(startTextBox) : GanttChartView.CurrentTime);
        }
    }
}
