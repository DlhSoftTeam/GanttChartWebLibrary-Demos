<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Demos.Samples.CSharp.ScheduleChartView.ContinuousSchedule.Index" %>
...
<html>
<head runat="server">
    <title>ScheduleChartView Continuous Schedule Sample</title>
