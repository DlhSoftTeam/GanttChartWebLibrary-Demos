<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Demos.Samples.CSharp.ScheduleChartView.CustomScale.Index" %>
...
<html>
<head runat="server">
    <title>ScheduleChartView Custom Scale Sample</title>
