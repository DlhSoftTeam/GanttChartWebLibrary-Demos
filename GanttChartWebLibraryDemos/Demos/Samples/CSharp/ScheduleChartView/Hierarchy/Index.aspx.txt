<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Demos.Samples.CSharp.ScheduleChartView.Hierarchy.Index" %>
...
<html>
<head runat="server">
    <title>ScheduleChartView Hierarchy Sample</title>
