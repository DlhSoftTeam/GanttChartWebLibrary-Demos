<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Demos.Samples.CSharp.ScheduleChartView.Printing.Index" %>
...
<html>
<head runat="server">
    <title>ScheduleChartView Printing Sample</title>
...
<body>
    ...
    <asp:UpdatePanel ID="MainPanel" runat="server">
                ...
                <div class="ribbonPanel">
                    ...
                    <div class="ribbonCommandsArea">
                        <div class="ribbonCommand">
                            <asp:ImageButton ID="PrintImageButton" runat="server" OnClick="PrintImageButton_Click" ImageUrl="Images/Print.png" ToolTip="Print" AlternateText="Print" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <Triggers>
            <asp:PostBackTrigger ControlID="PrintImageButton" />
        </Triggers>
    </asp:UpdatePanel>
    </form>
</body>
