<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Demos.Samples.CSharp.ScheduleChartView.ResourceStatus.Index" %>
...
<html>
<head runat="server">
    <title>ScheduleChartView Resource Status Sample</title>
