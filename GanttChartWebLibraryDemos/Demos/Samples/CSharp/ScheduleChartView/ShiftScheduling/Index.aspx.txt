<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Demos.Samples.CSharp.ScheduleChartView.ShiftScheduling.Index" %>
...
<html>
<head runat="server">
    <title>ScheduleChartView Shift Scheduling Sample</title>
...
<body>
    ...
    <asp:UpdatePanel ID="MainPanel" runat="server">
        <ContentTemplate>
            <pdgcc:ScheduleChartView ID="ScheduleChartView" runat="server" Height="416px" />
        </ContentTemplate>
    </asp:UpdatePanel>
    </form>
</body>
