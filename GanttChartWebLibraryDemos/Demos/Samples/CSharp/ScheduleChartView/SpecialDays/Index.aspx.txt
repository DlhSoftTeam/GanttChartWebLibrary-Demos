<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Demos.Samples.CSharp.ScheduleChartView.SpecialDays.Index" %>
...
<html>
<head runat="server">
    <title>ScheduleChartView Special Days Sample</title>
