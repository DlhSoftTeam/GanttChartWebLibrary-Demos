...
Public Class IndexLocal
    ...
    Public Sub ProjectStatisticsButton_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        ScriptManager.RegisterStartupScript(Me, GetType(IndexLocal), "ProjectStatistics", "setTimeout(function() { alert('" + output + "'); }, 1000);", True)
    End Sub
    Public Sub SaveProjectXmlButton_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        ScriptManager.RegisterClientScriptBlock(Me, GetType(IndexLocal), "Download", "window.open('DownloadLocal.aspx?ContentType=text/xml&Filename=Project.xml', '_blank');", True)
    End Sub
    ...
    Protected Sub Page_PreRender(ByVal sender As Object, ByVal e As EventArgs)
        ...
        End If
        ScriptManager.RegisterClientScriptBlock(Me, GetType(IndexLocal), "LoadChartResourceFilterChanged", String.Format(ControlChars.CrLf & "function loadChartResourceFilterChanged()" & ControlChars.CrLf & "{{" & ControlChars.CrLf & "var ganttChartView = document.querySelector('#{0}');" & ControlChars.CrLf & "if (typeof ganttChartView.refreshLoadChartView !== 'undefined')" & ControlChars.CrLf & "ganttChartView.refreshLoadChartView();" & ControlChars.CrLf & "}}", GanttChartView.ClientID), True)
